...
| `nomad.nomad.fsm.apply_auth_method_delete`           | Time elapsed to apply `ApplyAuthMethodDelete` raft entry                       | Nanoseconds          | Summary | host                                                    |
| `nomad.nomad.fsm.apply_auth_method_upsert`           | Time elapsed to apply `ApplyAuthMethodUpsert` raft entry                       | Nanoseconds          | Summary | host                                                    |
