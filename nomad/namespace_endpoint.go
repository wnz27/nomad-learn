...
func (n *Namespace) UpsertNamespaceExample(
	...
	return Chain(
		authenticationMiddleware[*structs.NamespaceUpsertRequest, *structs.GenericResponse](),
		forwardingAuthoritativeRegionMiddleware[*structs.NamespaceUpsertRequest, *structs.GenericResponse](
			"Namespace.UpsertNamespaceExample", n.srv.config.AuthoritativeRegion),
		metricsMiddleware[*structs.NamespaceUpsertRequest, *structs.GenericResponse](
			[]string{"nomad", "namespace", "upsert_namespaces"},
		),
		authorizationMiddleware[*structs.NamespaceUpsertRequest, *structs.GenericResponse](acl.PolicyWrite),
	)(
